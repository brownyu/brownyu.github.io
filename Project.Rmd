...
setwd("C:/Users/Eugene Wong/Desktop/SMU/Big Data/Project")
sc <- spark_connect(master = "local", version = "3.3.0")
...
```{r}
dropout<-dropout |> 
  mutate_at(vars(MaritalStatus,ApplicationMode,Course,MotherQualification,FatherQualification,
                 MotherOccupation,FatherOccupation,Debtor,Tuition_fees_up_to_date),as.numeric)
